package com.newroad.data.common.openmessage.lib;

import com.newroad.data.common.openmessage.lib.base.ISender;
import com.newroad.data.common.openmessage.lib.base.SenderWapper;
import com.newroad.data.common.openmessage.config.AppConfig;
import com.newroad.data.common.openmessage.config.MailConfig;
import com.newroad.data.common.openmessage.config.MessageConfig;
 ...
 * Then,send the request data by a mode of mail.It is different from {@link MAILSend}
